...
var appSettings = {
    ...
    everlive: {
        apiKey: 'oEEhBHBXVEjLEl6R', // Put your Backend Services API key here
        scheme: 'http',
        url: ''
    },

    eqatec: {
        productKey: 'a038869c95014547b5477afdbbaebfb6',  // Put your EQATEC product key here
        version: '1.0.0.0' // Put your application version here
    },
    
    feedback: {
        apiKey: '29314730-9827-11e5-a86a-1514748a2bb1',  // Put your AppFeedback API key here
        options: {
            enableShake: true,
